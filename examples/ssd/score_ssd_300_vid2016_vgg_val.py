...
output_result_dir = "{}/visenzeWork/ssd_object_detect/results/ILSVRC2016/val_all/{}".format(
    os.environ['HOME'], job_name+'_val_all_vgg')
# The name of the model. Modify it if you want.
model_name = "VGG_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/ILSVRC2016_VID/{}_val_all_vgg".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/ILSVRC2016_VID/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/ILSVRC2016_VID/{}_val_all_vgg".format(job_name)
