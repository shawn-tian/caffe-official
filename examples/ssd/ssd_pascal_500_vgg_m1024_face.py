...
train_data = "/mnt/disk_06/shangxuan/ssd_lmdb/face_det_train_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/mnt/disk_06/shangxuan/ssd_lmdb/face_det_val_lmdb"
...
name_size_file = "data/{}/val_name_size.txt".format(dataset)
# The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
pretrain_model = "models/{}/VGG_CNN_M_1024_fc_reduced.caffemodel".format(network_type)
# pretrain_model = "models/ResNet/ResNet-101-model.caffemodel"
# Stores LabelMapItem.
label_map_file = "data/{}/labelmap_face.prototxt".format(dataset)
