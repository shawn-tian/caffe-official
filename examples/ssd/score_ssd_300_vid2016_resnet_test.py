...
output_result_dir = "{}/visenzeWork/ssd_object_detect/results/ILSVRC2016/test_final/{}".format(
    os.environ['HOME'], job_name+'_test_final_resnet')
# The name of the model. Modify it if you want.
model_name = "ResNet_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNet/ILSVRC2016_VID/{}_test_final_resnet".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/ILSVRC2016_VID/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/ILSVRC2016_VID/{}_test_final_resnet".format(job_name)
