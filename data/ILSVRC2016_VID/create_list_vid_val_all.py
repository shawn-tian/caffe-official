...
train_list_file = "{}/vid_train+det30_trainval_all.txt".format(CURDIR)
val_list_file = "{}/vid_val_all.txt".format(CURDIR)
val_name_size_file = "{}/vid_val_name_size_all.txt".format(CURDIR)
...
imgset_list = "ImageSets/image_list_all.txt"
if redo or not os.path.exists(val_list_file):
    datasets = ["val"]
    img_files = []
    anno_files = []
