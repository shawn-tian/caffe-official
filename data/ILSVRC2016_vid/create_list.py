...
DATA_PATH = os.path.expanduser("/mnt/disk_06/shangxuan/vid_imagenet2016/train")
CURDIR = os.path.dirname(os.path.realpath(__file__))

# If true, re-create all list files.
redo = False
# The root directory which holds all information of the dataset.
data_dir = "{}/data/ILSVRC".format(DATA_PATH)
...
if redo or not os.path.exists(train_list_file):
    ...
    for dataset in datasets:
        imgset_file = "{}/{}/{}.txt".format(data_dir, dataset, imgset_dir)
